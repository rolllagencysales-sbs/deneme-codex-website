        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="font-body text-foreground/60 leading-relaxed">
              Her projede, markanın hedef kitlesini anlamak, estetik ve işlevselliği birleştirmek
              ve özgün çözümler sunmak önceliğimizdir. Amacımız sadece tasarım yapmak değil;
              markaların dijital dünyada fark edilmesini sağlayan, akılda kalıcı ve etkili bir
              deneyim yaratmaktır.
            </p>
          </div>
          ...
          >
            ...
            <p className="font-body text-foreground/60 leading-relaxed">
              Rolll Agency olarak, her adımda yenilikçi, stratejik ve yaratıcı yaklaşımlarımızla
              müşterilerimizin başarısını büyütmeyi hedefliyoruz. Çözümlerimiz her zaman
              markanızın hedefleriyle uyumlu ve sonuç odaklıdır.
            </p>
          </div>
        </div>
      </div>
